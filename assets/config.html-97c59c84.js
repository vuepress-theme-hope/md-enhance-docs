...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>默认值: <code>{ status: &quot;dev&quot; }</code></p></li></ul><p>是否启用链接检查。</p><h3 id="vpre" tabindex="-1"><a class="header-anchor" href="#vpre" aria-hidden="true">#</a> vPre</h3>`,7),w=n("li",null,[s("类型: "),n("code",null,"boolean")],-1),x=n("li",null,[s("默认值: "),n("code",null,"false")],-1),T=e('<p>是否启用 v-pre 容器。</p><h3 id="breaks" tabindex="-1"><a class="header-anchor" href="#breaks" aria-hidden="true">#</a> breaks</h3><ul><li>类型: <code>boolean</code></li><li>默认值: <code>false</code></li><li>在 GFM 中启用: 是</li></ul><p>是否将段落中的 <code>\\n</code> 转换为 <code>&lt;br&gt;</code></p><h3 id="linkify" tabindex="-1"><a class="header-anchor" href="#linkify" aria-hidden="true">#</a> linkify</h3><ul><li>类型: <code>boolean</code></li><li>默认值: <code>false</code></li><li>在 GFM 中启用: 是</li></ul><p>是否将文字中的链接格式文字转换为链接</p><h3 id="tabs" tabindex="-1"><a class="header-anchor" href="#tabs" aria-hidden="true">#</a> tabs</h3>',8),_=n("li",null,[s("类型: "),n("code",null,"boolean")],-1),q=n("li",null,[s("默认值: "),n("code",null,"false")],-1),M=n("p",null,"是否启用选项卡。",-1),L=n("h3",{id:"codetabs",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#codetabs","aria-hidden":"true"},"#"),s(" codetabs")],-1),C=n("li",null,[s("类型: "),n("code",null,"boolean")],-1),R=n("li",null,[s("默认值: "),n("code",null,"false")],-1),O=n("p",null,"是否启用代码组。",-1),S=n("h3",{id:"align",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#align","aria-hidden":"true"},"#"),s(" align")],-1),j=n("li",null,[s("类型: "),n("code",null,"boolean")],-1),H=n("li",null,[s("默认值: "),n("code",null,"false")],-1),P=n("p",null,"是否启用自定义对齐格式支持。",-1),z=n("h3",{id:"attrs",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#attrs","aria-hidden":"true"},"#"),s(" attrs")],-1),V=e(`<li><p>类型: <code>AttrsOptions | boolean</code></p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">AttrsOptions</span> <span class="token punctuation">{</span>
  <span class="token doc-comment comment">/**
   * 左分隔符
   *
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>定义需要传递给 Echarts 的全局配置选项和设置函数。</p><h3 id="definemermaidconfig" tabindex="-1"><a class="header-anchor" href="#definemermaidconfig" aria-hidden="true">#</a> defineMermaidConfig</h3><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">const</span> <span class="token function-variable function">defineMermaidConfig</span><span class="token operator">:</span> <span class="token punctuation">(</span>options<span class="token operator">:</span> MermaidConfig<span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token keyword">void</span><span class="token punctuation">;</span>
</code></pre></div><p>定义需要传递给 Mermaid 的配置选项。</p><h3 id="definerevealjsconfig" tabindex="-1"><a class="header-anchor" href="#definerevealjsconfig" aria-hidden="true">#</a> defineRevealJsConfig</h3><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">const</span> <span class="token function-variable function">defineRevealJsConfig</span><span class="token operator">:</span> <span class="token punctuation">(</span>options<span class="token operator">:</span> RevealOptions<span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token keyword">void</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>定义需要传递给 <code>@vue/repl</code> 的选项。</p>`,68);function ln(tn,on){const t=p("ExternalLinkIcon"),i=p("RouterLink");return o(),c("div",null,[u,n("div",v,[m,n("p",null,[s("有关完整的 GFM 语法，请参阅 "),n("a",k,[s("GFM"),a(t)]),s("。")]),b,h]),g,n("ul",null,[f,Q,n("li",null,[s("详情: "),n("ul",null,[n("li",null,[a(i,{to:"/zh/guide/container.html"},{default:l(()=>[s("自定义容器")]),_:1})])])])]),y,n("ul",null,[w,x,n("li",null,[s("详情: "),n("ul",null,[n("li",null,[a(i,{to:"/zh/guide/others.html#v-pre"},{default:l(()=>[s("v-pre")]),_:1})])])])]),T,n("ul",null,[_,q,n("li",null,[s("详情: "),n("ul",null,[n("li",null,[a(i,{to:"/zh/guide/tabs.html"},{default:l(()=>[s("选项卡")]),_:1})])])])]),M,L,n("ul",null,[C,R,n("li",null,[s("详情: "),n("ul",null,[n("li",null,[a(i,{to:"/zh/guide/code-tabs.html"},{default:l(()=>[s("代码组")]),_:1})])])])]),O,S,n("ul",null,[j,H,n("li",null,[s("详情: "),n("ul",null,[n("li",null,[a(i,{to:"/zh/guide/align.html"},{default:l(()=>[s("自定义对齐")]),_:1})])])])]),P,z,n("ul",null,[V,n("li",null,[E,n("ul",null,[n("li",null,[a(i,{to:"/zh/guide/attrs.html"},{default:l(()=>[s("定义属性")]),_:1})])])])]),D,n("p",null,[s("是否通过 KaTeX 启用 "),n("mjx-container",J,[(o(),c("svg",F,I)),U]),s(" 语法支持。你可以传入一个对象作为 KaTeX 的配置选项。")]),B,n("p",null,[s("可用的选项，详见 "),n("a",N,[s("Katex 文档"),a(t)]),s("。")]),A,K,n("p",null,[s("是否通过 Math Jax 启用 "),n("mjx-container",W,[(o(),c("svg",X,$)),Y]),s(" 语法支持。你可以传递一个对象来配置 Math Jax。")]),n("p",null,[s("可用的选项，详见 "),n("a",nn,[s("源代码"),a(t)]),s("。")]),sn,n("p",null,[s("是否启用 "),n("a",an,[s("Mermaid"),a(t)]),s(" 支持，你可以传入一个对象作为 Mermaid 的配置选项。")]),en])}const dn=d(r,[["render",ln],["__file","config.html.vue"]]);export{dn as default};

...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>Default: <code>{ status: &quot;dev&quot; }</code></p></li></ul><p>Whether to enable links check.</p><h3 id="vpre" tabindex="-1"><a class="header-anchor" href="#vpre" aria-hidden="true">#</a> vPre</h3>`,7),T=n("li",null,[s("Type: "),n("code",null,"boolean")],-1),w=n("li",null,[s("Default: "),n("code",null,"false")],-1),x=e('<p>Whether to enable v-pre wrapper.</p><h3 id="breaks" tabindex="-1"><a class="header-anchor" href="#breaks" aria-hidden="true">#</a> breaks</h3><ul><li>Type: <code>boolean</code></li><li>Default: <code>false</code></li><li>Enabled in GFM: Yes</li></ul><p>Whether convert <code>\\n</code> in paragraphs into <code>&lt;br&gt;</code>s</p><h3 id="linkify" tabindex="-1"><a class="header-anchor" href="#linkify" aria-hidden="true">#</a> linkify</h3><ul><li>Type: <code>boolean</code></li><li>Default: <code>false</code></li><li>Enabled in GFM: Yes</li></ul><p>Whether convert URL-like text into links</p><h3 id="tabs" tabindex="-1"><a class="header-anchor" href="#tabs" aria-hidden="true">#</a> tabs</h3>',8),_=n("li",null,[s("Type: "),n("code",null,"boolean")],-1),q=n("li",null,[s("Default: "),n("code",null,"false")],-1),D=n("p",null,"Whether to enable tabs.",-1),C=n("h3",{id:"codetabs",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#codetabs","aria-hidden":"true"},"#"),s(" codetabs")],-1),P=n("li",null,[s("Type: "),n("code",null,"boolean")],-1),L=n("li",null,[s("Default: "),n("code",null,"false")],-1),R=n("p",null,"Whether to enable codetabs.",-1),M=n("h3",{id:"align",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#align","aria-hidden":"true"},"#"),s(" align")],-1),W=n("li",null,[s("Type: "),n("code",null,"boolean")],-1),j=n("li",null,[s("Default: "),n("code",null,"false")],-1),S=n("p",null,"Whether to enable custom align.",-1),O=n("h3",{id:"attrs",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#attrs","aria-hidden":"true"},"#"),s(" attrs")],-1),H=e(`<li><p>Type: <code>AttrsOptions | boolean</code></p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">AttrsOptions</span> <span class="token punctuation">{</span>
  <span class="token doc-comment comment">/**
   * left delimiter
   *
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>Required: No</p></li></ul><p>Locales config for Markdown Enhance Plugin.</p><details class="hint-container details"><summary>Built-in Supported Languages</summary><ul><li><strong>Simplified Chinese</strong> (zh-CN)</li><li><strong>Traditional Chinese</strong> (zh-TW)</li><li><strong>English (United States)</strong> (en-US)</li><li><strong>German</strong> (de-DE)</li><li><strong>German (Australia)</strong> (de-AT)</li><li><strong>Russian</strong> (ru-RU)</li><li><strong>Ukrainian</strong> (uk-UA)</li><li><strong>Vietnamese</strong> (vi-VN)</li><li><strong>Portuguese (Brazil)</strong> (pt-BR)</li><li><strong>Polish</strong> (pl-PL)</li><li><strong>French</strong> (fr-FR)</li><li><strong>Spanish</strong> (es-ES)</li><li><strong>Slovak</strong> (sk-SK)</li><li><strong>Japanese</strong> (ja-JP)</li><li><strong>Turkish</strong> (tr-TR)</li><li><strong>Korean</strong> (ko-KR)</li><li><strong>Finnish</strong> (fi-FI)</li><li><strong>Indonesian</strong> (id-ID)</li><li><strong>Dutch</strong> (nl-NL)</li></ul></details><h2 id="client-config" tabindex="-1"><a class="header-anchor" href="#client-config" aria-hidden="true">#</a> Client Config</h2><h3 id="defineechartsconfig" tabindex="-1"><a class="header-anchor" href="#defineechartsconfig" aria-hidden="true">#</a> defineEchartsConfig</h3><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">interface</span> <span class="token class-name">EchartsConfig</span> <span class="token punctuation">{</span>
  <span class="token doc-comment comment">/**
   * Echarts global options
   */</span>
  option<span class="token operator">?</span><span class="token operator">:</span> EChartsOption<span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">const</span> <span class="token function-variable function">defineEchartsConfig</span><span class="token operator">:</span> <span class="token punctuation">(</span>config<span class="token operator">:</span> EchartsConfig<span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token keyword">void</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Define global options and setup for Echarts.</p><h3 id="definemermaidconfig" tabindex="-1"><a class="header-anchor" href="#definemermaidconfig" aria-hidden="true">#</a> defineMermaidConfig</h3><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">const</span> <span class="token function-variable function">defineMermaidConfig</span><span class="token operator">:</span> <span class="token punctuation">(</span>options<span class="token operator">:</span> MermaidConfig<span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token keyword">void</span><span class="token punctuation">;</span>
</code></pre></div><p>Define config which you want to pass to mermaid.</p><h3 id="definerevealjsconfig" tabindex="-1"><a class="header-anchor" href="#definerevealjsconfig" aria-hidden="true">#</a> defineRevealJsConfig</h3><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">const</span> <span class="token function-variable function">defineRevealJsConfig</span><span class="token operator">:</span> <span class="token punctuation">(</span>options<span class="token operator">:</span> RevealOptions<span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token keyword">void</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Define config which you want to pass to <code>@vue/repl</code>.</p>`,65);function tn(ln,on){const l=c("ExternalLinkIcon"),t=c("RouterLink");return o(),p("div",null,[u,n("div",m,[v,n("p",null,[s("For full GFM syntax, see "),n("a",k,[s("GFM"),a(l)]),s(".")]),b,h]),g,n("ul",null,[f,y,n("li",null,[s("Details: "),n("ul",null,[n("li",null,[a(t,{to:"/guide/container.html"},{default:i(()=>[s("Custom Container")]),_:1})])])])]),Q,n("ul",null,[T,w,n("li",null,[s("Details: "),n("ul",null,[n("li",null,[a(t,{to:"/guide/others.html#v-pre"},{default:i(()=>[s("v-pre wrapper")]),_:1})])])])]),x,n("ul",null,[_,q,n("li",null,[s("Details: "),n("ul",null,[n("li",null,[a(t,{to:"/guide/tabs.html"},{default:i(()=>[s("Tabs")]),_:1})])])])]),D,C,n("ul",null,[P,L,n("li",null,[s("Details: "),n("ul",null,[n("li",null,[a(t,{to:"/guide/code-tabs.html"},{default:i(()=>[s("Code Tabs")]),_:1})])])])]),R,M,n("ul",null,[W,j,n("li",null,[s("Details: "),n("ul",null,[n("li",null,[a(t,{to:"/guide/align.html"},{default:i(()=>[s("Align")]),_:1})])])])]),S,O,n("ul",null,[H,n("li",null,[E,n("ul",null,[n("li",null,[a(t,{to:"/guide/attrs.html"},{default:i(()=>[s("Attrs")]),_:1})])])])]),z,n("p",null,[s("Whether to enable "),n("mjx-container",F,[(o(),p("svg",I,V)),G]),s(" syntax support through KaTeX. You can pass an object to config KaTeX.")]),N,n("p",null,[s("Please see "),n("a",Y,[s("Katex Docs"),a(l)]),s(" for available options.")]),U,A,n("p",null,[s("Whether to enable "),n("mjx-container",B,[(o(),p("svg",K,Z)),$]),s(" syntax support through Math Jax. You can pass an object to config Math Jax.")]),n("p",null,[s("Please see "),n("a",nn,[s("source code"),a(l)]),s(" for available options.")]),sn,n("p",null,[s("Whether to enable "),n("a",an,[s("Mermaid"),a(l)]),s(" support, you can pass in a config object to customize the behavior of Mermaid.")]),en])}const dn=d(r,[["render",tn],["__file","config.html.vue"]]);export{dn as default};

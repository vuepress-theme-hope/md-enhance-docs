import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as c,c as o,b as n,d as e,a as i,e as s}from"./app-e004c2b0.js";const t={},p=n("h2",{id:"传统模式",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#传统模式","aria-hidden":"true"},"#"),e(" 传统模式")],-1),u=n("p",null,[e("你可以在调用 "),n("code",null,"mdEnhancePlugin"),e(" 时传递第二个参数 "),n("code",null,"true"),e(" 以启用传统模式，插件将尝试以 V1 行为运行。")],-1),r=n("h2",{id:"新功能",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#新功能","aria-hidden":"true"},"#"),e(" 新功能")],-1),v=s(`<li><p>Markdown 链接检查</p><p>该插件现在检查你的 Markdown 链接，并在检测到损坏的链接时警告你。</p><p>你可以通过 <code>checkLinks</code> 选项控制此行为</p></li><li><p>图像标记支持</p><p>通过 <code>imgMark</code> 选项使用 <code>#light</code> 和 <code>#dark</code> 后缀标记图像以在日间模式或夜间模式下显示它们。</p></li><li><p><code>v-pre</code> 支持</p><p>VuePress 2 从 <code>@vuepress/core</code> 中删除了以下容器支持，因此添加了 <code>vPre</code> 选项</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code>::: v-pre
